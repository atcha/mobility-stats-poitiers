  ...
  <div id="app">
    <div class="logo">
		...
		c0,0.1,0,0.2,0.1,0.2C25.8,16.3,29.4,12.6,33.1,8.9z"/>
            <path id="XMLID_74_" class="wheel1" d="M1.1,21.3c0-5.9,6.1-10,11.6-7.7c0,0,0.1,0,0.1,0.1c0.4,0.2,0.7,0.4,0.5,0.9c-0.2,0.4-0.5,0.4-0.9,0.3
		...
		C4.5,29.3,1.1,25.7,1.1,21.3z"/>
            <path id="XMLID_73_" class="wheel2" d="M45.6,20.9c0,5.4-4.2,9.2-9.1,8.8c-3.8-0.3-6.9-3.2-7.6-7.1c-0.6-3.7,1.4-7.4,4.9-8.9
    ...
    <h1>Les données mobilité de Grand Poitiers</h1>
    <MobilityGraph />
  </div>
</template>
...
<style>
  ...
  .logo:hover .wheel1 {
      transform-origin: 9.5px 21.5px;
      animation: rotate 2s linear infinite;
  }
  .logo:hover .wheel2 {
      transform-origin: 37px 21.5px;
